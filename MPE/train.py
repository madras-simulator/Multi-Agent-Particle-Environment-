...
from make_torcs_env import MultiAgentTorcsEnv
...
def parse_args():
    ...
    parser.add_argument("--save-dir", type=str, default="/home/sohan/shipping/maddpgCheckPoints", help="directory in which training state and model should be saved")
...
def train(arglist):
    with U.single_threaded_session():
        ...
        os.system("torcs -t 10000000 -nolaptime &") #use the location of torcs installation on your system
        print("TORCS STARTED")
        time.sleep(0.5)
        ...
        while True:
            ...
            # environment step
            new_obs_n, rew_n, done_n, info_n = env.step(action_n,epsilon, train_indicator)
            episode_step += 1
